...
app.py
------
Entry point for the AI Cold Email Generator Streamlit application.

Run with:
    streamlit run app.py

All UI logic lives here. Business logic is delegated to the `src/` package.
"""

import streamlit as st
from langchain_community.document_loaders import WebBaseLoader

from src.email_generator import Chain
